...
if __name__ == "__main__":
    ...
    # ---------------------------
    train_dataset = load_dataset("json", data_files = "json_datasets/train_preprocessed_OLD.jsonl", split = "train")
    test_dataset = load_dataset("json", data_files = "json_datasets/test_preprocessed_OLD.jsonl", split = "train")
