...
if __name__ == "__main__":
    ...
    # ---------------------------
    synthetic_train_dataset = load_dataset("json", data_files = "json_datasets/train_synthetic_preprocessed.jsonl", split = "train")
    ...
    synthetic_train_dataset = synthetic_train_dataset.map(preprocess, remove_columns = ["context", "question", "answer"])
    ...
    print("\nSynthetic Fine-Tuning Complete. Model checkpoints saved to {}".format(args.output_path))
